...
Feature 1: I used the inverse colour combination of a very Irish symbol, the colours of a drink of Guinness. Also the "Sign-Up!" and                "Restaurant Booking" forms again use the same colours inverted again appearring like a pint of Guinness with narrow long                form structures.
...
• I would like to thank my mentor Ade (gbenga_mentor) who provided guidance through-out the project.
  I'd also like to thank Eventyret_mentor and JosV for some very useful pointers which helped me and the Slack community.
...
The sites used for reference throughout the project are:
